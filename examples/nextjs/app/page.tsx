...
export default function Home() {
  return (
    ...
    >
      <div
        className={[
          "z-10 max-w-5xl w-full items-center justify-between font-mono text-sm",
          "lg:flex",
        ]}
      >
        <p
          className={[
            "fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl",
        ...
        <div
          className={[
            "fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white",
      ...
      <a href="https://github.com/zjxxxxxxxxx/babel-plugin-clsx#readme">
        <div
          className={[
            "relative flex place-items-center flex-col text-5xl font-medium z-[-1]",
      ...
      <div
        className={[
          ...
          "lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left",
        ]}
      >
        <a
